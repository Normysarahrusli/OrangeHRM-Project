...
WebUI.click(findTestObject('Perfromance/delete kpi/Page_OrangeHRM/input_Payroll Administrator_chkSelectRow'))

WebUI.click(findTestObject('Perfromance/delete kpi/Page_OrangeHRM/input_QA Lead_chkSelectRow'))
