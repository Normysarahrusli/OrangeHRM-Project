...
WebUI.setText(findTestObject('Perfromance/add/input__defineKpi360minRating'), '200')
...
WebUI.verifyElementPresent(findTestObject('Perfromance/add/span_Should be less than 100 - Copy'), 0)
