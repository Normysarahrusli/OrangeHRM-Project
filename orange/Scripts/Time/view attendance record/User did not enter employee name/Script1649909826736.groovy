...
WebUI.click(findTestObject('Object Repository/Time/Page_OrangeHRM/img__ui-datepicker-trigger'))

WebUI.click(findTestObject('Object Repository/Time/Page_OrangeHRM/a_14'))

WebUI.click(findTestObject('Object Repository/Time/Page_OrangeHRM/input__btView'))

WebUI.verifyElementPresent(findTestObject('Time/Page_OrangeHRM/Page_OrangeHRM/span_Employee Name'), 0)
