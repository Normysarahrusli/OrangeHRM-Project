...
WebUI.setText(findTestObject('Perfromance/add/input__defineKpi360keyPerformanceIndicators'), '80')

WebUI.setText(findTestObject('Perfromance/add/input__defineKpi360minRating'), 'abc')

WebUI.setText(findTestObject('Perfromance/add/input__defineKpi360maxRating'), '200')
...
WebUI.verifyElementPresent(findTestObject('Perfromance/add/span_Should be greater than 0'), 0)
