...
WebUI.click(findTestObject('Admin/delete job title/Page_OrangeHRM/Page_OrangeHRM/input_Software Architect_chkSelectRow'))

WebUI.click(findTestObject('Admin/delete job title/Page_OrangeHRM/Page_OrangeHRM/input_Support Specialist_chkSelectRow'))
